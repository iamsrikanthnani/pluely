...
export const Input = ({
  ...
  const handleStealthScroll = (keyCode: number) => {
    ...
    switch (keyCode) {
      case 38: // Arrow Up
        scrollViewport.scrollTo({ top: currentScroll - 40, behavior: "auto" });
        break;
      case 40: // Arrow Down
        scrollViewport.scrollTo({ top: currentScroll + 40, behavior: "auto" });
        break;
      case 33: // Page Up
        scrollViewport.scrollTo({
          top: currentScroll - clientHeight,
          behavior: "smooth",
        });
        break;
      case 34: // Page Down
      ...
      case 36: // Home
        ...
        break;
      case 35: // End
        scrollViewport.scrollTo({ top: scrollHeight, behavior: "smooth" });
        break;
    }
  };
